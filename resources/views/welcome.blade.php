...
@section('content')
        <div class="main_slider_wrapper slider-area jb_cover">
            <div class="mains_slider_shaper">
                <img src="{{ asset('images/slider_bg.png') }}" class="img-responsive" alt="img">
            </div>
            ...
            <div class="slider_shape_smt bubble-1">
                <img src="{{ asset('images/bubble.png') }}" class="img-responsive " alt="img">
            </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div data-animation="animated fadeInUp" class="btn_hover slider_btn">
                                        <a href="{{ route('login') }}">sign up free</a>
                                    </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                    ...
                                    <img src="{{ asset('images/slider_img.png') }}" class="img-responsive" alt="img">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="jp_job_post_side_img">
                                                <img src="{{ asset('images/lt5.png') }}" alt="post_img" />
                                            </div>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="jp_job_post_side_img">
                                                <img src="{{ asset('images/lt2.png') }}" alt="post_img" />
                                            </div>
                                            <div class="jp_job_post_right_cont">
                                                <h4><a href="#">web  Designer </a></h4>
                                                <ul>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="jp_job_post_side_img">
                                                <img src="{{ asset('images/lt3.png') }}" alt="post_img" />
                                            </div>
                                            <div class="jp_job_post_right_cont">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="jp_job_post_side_img">
                                                <img src="{{ asset('images/lt4.png') }}" alt="post_img" />
                                            </div>
                                            <div class="jp_job_post_right_cont">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <img src="{{ asset('images/mockup6.png') }}" class="img-responsive" alt="img">
                        </div>
                        <div class="counter_jbbb jb_cover">
                        <img src="{{ asset('images/line2.png') }}" class="img-responsive" alt="img">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="counter_width">
                            <div class="counter_cntnt_box">
                                <div class="count-description">
                                    <span class="timer">9</span><span>+</span>
            ...
            <div class="counter_jbbb2 jb_cover">
                <img src="{{ asset('images/line3.png') }}" class="img-responsive" alt="img">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 offset-lg-1 col-md-12 col-sm-12">
                        <div class="jb_heading_wraper">
                        <h3>Control everything from your business</h3>
                        <p>Your next level Product developemnt company assets</p>
                        </div>
                    </div>
